## [3.0.0rc1](https://github.com/deshaw/jupyterlab-notify/compare/v2.0.2...v3.0.0rc1) (UNRELEASED)

## Changed

- Refactored the extension ([#10](https://github.com/deshaw/jupyterlab-notify/pull/10)) with support for:
  - per-cell and per-notebook configuration UI,
  - Slack notifications,
  - new notification modes (when done after threshold, on error, after timeout, never),
  - server-side execution (optional).

## [2.0.2](https://github.com/deshaw/jupyterlab-notify/compare/v2.0.2...v2.0.1) (2025-02-19)
